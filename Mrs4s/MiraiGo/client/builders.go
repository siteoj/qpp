...
import (
	...
	"Mrs4s/MiraiGo/binary/jce"
	"Mrs4s/MiraiGo/client/pb"
	"Mrs4s/MiraiGo/client/pb/cmd0x352"
	"Mrs4s/MiraiGo/client/pb/msg"
	"Mrs4s/MiraiGo/client/pb/multimsg"
	"Mrs4s/MiraiGo/client/pb/oidb"
	"Mrs4s/MiraiGo/client/pb/pttcenter"
	"Mrs4s/MiraiGo/client/pb/structmsg"
	"Mrs4s/MiraiGo/message"
	"Mrs4s/MiraiGo/protocol/crypto"
	"Mrs4s/MiraiGo/protocol/packets"
	"Mrs4s/MiraiGo/protocol/tlv"
	"Mrs4s/MiraiGo/utils"
